...
export async function GET(
  ...
  try {
    ...
    const userOrderIds = (userOrdersData.data || []).map((o: any) => o.attributes ? o.attributes.orderId : o.orderId)
    ...
    const order = userOrdersData.data.find((o: any) => (o.attributes ? o.attributes.orderId : o.orderId) === orderId)
