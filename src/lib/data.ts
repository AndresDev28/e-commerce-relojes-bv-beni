...
export const featuredProducts = [
  {
    ...
    price: 199.99,
    images: ['/images/products/gshock/gm2100/gm2100-1.avif',
    ...
    description: 'Descubre el Casio G‑Shock GM‑2100, la versión “Metal Covered” del icónico GA‑2100 con caja octogonal de acero inoxidable y estructura resistente de resina. Ligero (72 g) y robusto, ofrece una estética premium manteniendo la legendaria durabilidad G‑Shock'
  },
  {
    id: 'casio-vintage-a168wem-1ef',
    name: 'Casio Vintage A168WEM-1EF',
    price: 59.99,
    images: ['/images/products/vintage/a168wem-1ef/a168wem.avif',
  ...
  },
  {
    ...
    price: 279.99,
    images: ['/images/products/edifice/efss570/efs-s570.avif',
  ...
  },
  {
    ...
    price: 99.99,
    images: ['/images/products/gshock/ga2100/ga2100-1.avif',
